          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span
                  className={
                    active === "ViewMarketplace"
                      ? "ml-3 text-[#0654D6]"
                      : "ml-3 text-[#333333]"
                  }
                >
                  {" "}
                  View/Edit Marketplace
                </span>
              </Link>
            </li>
            <li>
                ...
                >
                  <g clip-path="url(#clip0_386_1617)">
                    <path
                      ...
                      fill={
                        active === "createPromotion" ? "#0654D6" : "#333333"
                      }
                    />
                  </g>
                  <defs>
              ...
              >
                ...
                >
                  <path
                    ...
                    fill={
                      active === "createNotification" ? "#0654D6" : "#333333"
                    }
                  />
                </svg>
                <span
                  className={
                    active === "createNotification"
                      ? "ml-3 text-[#0654D6]"
                      : "ml-3 text-[#333333]"
                  }
                >
